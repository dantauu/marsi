...
export const AddHobbies = ({
  ...
  return (
    ...
    >
      <div>
        <p className="text-xl font-HelveticaB text-[18px] mini-mobile:text-[20px]">Увлечения</p>
        ...
        {!isValue && (
          <Button
            ...
            variant={"default"}
          >
            Добавить <SvgPlus className="w-[25px] h-[25px] mini-mobile:w-[30px] mini-mobile:h-[30px]" />
          </Button>
        )}
      </div>
    </div>
